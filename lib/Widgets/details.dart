import 'package:coro_app_updates/Models/reportModel.dart';
        ...
        children: <Widget>[
          Container(
            child: Row(
              ...
              children: <Widget>[
                createDetailItem(context: context, color: Colors.blue[400], value: report.recoveredCases, text: "Recovered"),
                createDetailItem(context: context, color: Colors.blue[900], value: report.confirmedCases, text: "Affected", todaysUpdate: todayAffeced),
              ],
            ),
          ),
          Container(
